    ...
    <div className=" flex justify-center items-center bg-black text-white font-outfit gap-4 py-10">
      <div className="w-full max-w-3xl px-6">
        ...
        <div className="mb-6">
          ...
          <div className="w-full h-56 px-4 py-3 bg-[#1e2524] rounded-lg border border-gray-700 text-gray-400">
            <p className="text-sm opacity-60">E.g</p>
            <ul className="text-md mt-2 leading-relaxed">
        ...
        <div className="flex items-center justify-between mb-6 rounded-lg border h-20 border-gray-700 bg-[#1e2524]">
          <span className="text-md text-gray-400 pl-6">Set Event to Private</span>
        ...
        <div className="flex flex-col gap-4 items-end">
          <button className="px-6 py-2 w-40 h-12 border border-teal-400 text-teal-400 rounded-lg hover:bg-teal-500 hover:text-black transition">
            Add Section
          </button>
          <button className="px-6 py-2 w-32 h-12 my-12 bg-black rounded-lg shadow-sm shadow-teal-500">
            Preview
          </button>
        </div>
      </div>
